  ...
  return (
    <section className="w-full max-w-md rounded-[2rem] border border-blue-400/20 bg-slate-950/80 p-8 shadow-2xl shadow-blue-950/40">
      ...
      <button
        ...
        className="mt-8 flex w-full items-center justify-center gap-3 rounded-full bg-white px-5 py-3 text-center text-sm font-semibold text-slate-900 shadow-lg shadow-blue-500/25 transition hover:bg-slate-100"
      >
        <svg aria-label="Google logo" className="h-5 w-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path
            fill="#4285F4"
